...
/**
 * Create or open a shared memory object with the specified name and size. If the O_CREAT flag is set, a new shared
 * memory object will be created if one does not already exist. If the O_CREAT flag is not set, an existing shared
 ...
 * @param flags The flags for opening the shared memory object. Can be O_CREAT to create a new object if it does not
 * exist.
