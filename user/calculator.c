...
static const calc_button_t calc_buttons[] = {
    {'7', BUTTON_START_X + 0 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 0 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'8', BUTTON_START_X + 1 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 0 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'9', BUTTON_START_X + 2 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 0 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'+', BUTTON_START_X + 3 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 0 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'4', BUTTON_START_X + 0 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 1 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'5', BUTTON_START_X + 1 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 1 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'6', BUTTON_START_X + 2 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 1 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'-', BUTTON_START_X + 3 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 1 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'1', BUTTON_START_X + 0 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 2 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'2', BUTTON_START_X + 1 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 2 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'3', BUTTON_START_X + 2 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 2 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'*', BUTTON_START_X + 3 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 2 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'C', BUTTON_START_X + 0 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 3 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'0', BUTTON_START_X + 1 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 3 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'=', BUTTON_START_X + 2 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 3 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
    {'/', BUTTON_START_X + 3 * (BUTTON_W + BUTTON_GAP), BUTTON_START_Y + 3 * (BUTTON_H + BUTTON_GAP), BUTTON_W, BUTTON_H},
};
...
static const uint8_t *glyph_for_char(char ch)
{
    ...
    case '*': return glyph_mul;
    case '/': return glyph_div;
